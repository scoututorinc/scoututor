...
import PersonRow from 'app/chat/components/ChatSettings/PeopleSettings/PersonRow'
import PersonForm from 'app/chat/components/ChatSettings/PeopleSettings/PersonForm'
...
const PeopleSettings = () => {
  ...
  function renderChatPeople(people, chat) {
    return people.map((chatPerson, index) => {
      return (
        <PersonRow key={`person_${index}`} person={chatPerson.person} conn={conn} chat={chat} />
      )
    })
  }
