...
import Thumbnail from 'app/chat/components/ChatSettings/PhotosSettings/Thumbnail'
...
const PhotosSettings = () => {
  ...
  return (
    <div style={{ borderTop: '1px solid #f0f0f0' }} className='ce-photo-section'>
      <SettingsBlock label='Photos' className='ce-section-title-container ce-photo-title-container'>
